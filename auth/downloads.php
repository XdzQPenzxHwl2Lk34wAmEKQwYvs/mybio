...
<head>
    ...
    <title>Downloads - undetect.space</title>
    ...
    <style>
        ...
        * {
        ...
        .download-card {
            background-color: var(--card-bg); /* Changed from gradient to solid */
            border-radius: 10px;
            padding: 20px;
            box-shadow: var(--shadow-md); /* Changed shadow */
            border: 1px solid var(--border); /* Changed border */
            transition: transform 0.3s ease, box-shadow 0.2s ease; /* Added box-shadow transition */
        }
        .download-card:hover {
        ...
        .download-icon {
            font-size: 2.5rem;
            color: var(--primary); /* Kept primary color */
            margin-bottom: 15px;
        }
        .download-title {
            font-size: 1.2rem;
...
<body>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Software Resources</div>
                    <div>Download the tools you need</div>
                </div>
                <div class="card-body">
                    <div class="download-grid">
                        <div class="download-card">
                            ...
                            <h3 class="download-title">C++ Example</h3>
                            <p class="download-description">Sample C++ implementation for integrating with our licensing system.</p>
                            <a href="">
                        ...
                        <div class="download-card">
                            ...
                            <h3 class="download-title">Hash Checker</h3>
                            <p class="download-description">Tool to verify the integrity of your program files.</p>
                            <a href="">
                        ...
                        <div class="download-card">
                            ...
                            <h3 class="download-title">C++ Auth Library</h3>
                            <p class="download-description">Pre-built authentication library for C++ applications.</p>
                            <a href="">
                                <i class="fas fa-download"></i> Download
                            </a>
                        </div>
                        <div class="download-card">
                            ...
                            <h3 class="download-title">Auto Save Key Example</h3>
                            <p class="download-description">C++ example demonstrating automatic license key saving.</p>
                            <a href="">
                                <i class="fas fa-download"></i> Download
                            </a>
                        </div>
                        <div class="download-card">
                            ...
                            <h3 class="download-title">API Bot Example</h3>
                            <p class="download-description">JavaScript bot example for API integration</p>
                            <a href="">
                                <i class="fas fa-download"></i> Download
                            </a>
                        </div>
    ...
    <script>
        // --- Background Animation Scripts (Copied from index.php) ---
