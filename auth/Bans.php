...
// Fetch banned licenses for this program and user
$check_license = mysqli_query($con, "SELECT * FROM license WHERE PROGRAM='" . mysqli_real_escape_string($con, $_SESSION['program']) . "' AND USER_ID='" . $_SESSION['ID'] . "' AND BANNED='Yes'");
$res_b = array();
...
if (isset($_POST['unban'])){
    mysqli_query($con, "UPDATE `license` SET `BANNED` = 'No', `BANNED_REASON` = 'NOT APPLICABLE' WHERE `id` = '" . mysqli_real_escape_string($con, $_POST['unban']) . "' AND `USER_ID` = '" . $_SESSION['ID'] . "'");
    fnx("Bans.php");
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Bans - undetect.space</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-links">
            ...
            <div class="nav-item">
                <a href="Bans.php" class="nav-link active">
    ...
    <div class="main-content">
        ...
        <div class="content">
            <h1 class="page-title">Banned Licenses</h1>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-title">Total Banned Licenses</div>
            ...
            <!-- Banned Licenses Table -->
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Banned Licenses</div>
                    <div>Manage banned licenses for your program</div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table>
                            ...
                            <tbody>
                                <?php if (empty($res_b)): ?>
                                    <tr>
                                        <td colspan="4" style="text-align: center; color: var(--text-muted);">No banned licenses found</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($res_b as $license): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($license['BANNED_REASON']); ?></td>
                                            <td>
                                                <div class="actions">
                                                    <form method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to unban this license?')">
                                                        <input type="hidden" name="unban" value="<?php echo htmlspecialchars($license['id']); ?>">
                                                        <button type="submit" class="btn btn-success btn-sm">
                                                            <i class="fas fa-undo"></i> <span>Unban</span>
                                                        </button>
                                                    </form>
                                                </div>
                                            </td>
