    ...
    if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] == 0) {
        ...
        if (in_array($file_extension, $allowed_extensions)) {
            ...
            if (move_uploaded_file($_FILES["profile_pic"]["tmp_name"], $target_file)) {
                ...
                $update_query = "UPDATE users SET profile_pic = '$target_file' WHERE ID = '" . $_SESSION['ID'] . "'";
...
<head>
    ...
    <title>Profile - undetect.space</title>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo isset($row[4]) ? htmlspecialchars($row[4]) : 'N/A'; ?>" readonly>
                    </div>

                    <div class="form-group">
                        <label>API Key</label>
                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($row['API_KEY'] ?? ''); ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
